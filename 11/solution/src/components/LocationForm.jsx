...
import {Modal, Button} from '@concur/nui-widgets';
...
export default React.createClass({
    ...
    render() {
        ...
        let {addLocation, cancelAddLocation, status} = this.props;
            ...
            <Modal
                ...
                show>
                    ...
                    <Modal.Body>
                        ...
                        {(status === "cancelled" || status === "adding" || status === 'added') && (
                            <div>
                                <br />
                    ...
                    <Modal.Footer>
                        ...
                        {/* adding cancel button when location in process of adding*/}
                        {status === "adding" && (
                            <Button onClick={() => {
                                cancelAddLocation();
                            }}>
                                <FormattedMessage id="locations.buttons.Cancel" />
                            </Button>
                        )}
